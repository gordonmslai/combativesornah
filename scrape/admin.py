...
from .models import Reservation, CombativesUser, OpenHours, Update, WeeklyDatabaseUpdate
...
@admin.register(WeeklyDatabaseUpdate)
class WeeklyDatabaseUpdateAdmin(admin.ModelAdmin):
    pass
